let marabic = document.getElementById("mmarabic");
let menglish = document.getElementById("mmenglish");
let persian = document.getElementById("mpersian");
let french = document.getElementById("mfrench");
let chinese = document.getElementById("mchinese");
...
marabic.onclick = () => {
	setLanguage("marabic");
	localStorage.setItem("Lang", "marabic");
};

menglish.onclick = () => {
	setLanguage("menglish");
	localStorage.setItem("Lang", "menglish");
};
...
function setLanguage(getLanguage){
	if(getLanguage === "marabic"){
		...
		reportSectionTitle.innerHTML = "التقارير";
		...
		reportSectionTitle.innerHTML = "گزارش ها";
