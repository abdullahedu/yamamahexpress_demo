...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('home/theme/template/css/bootstrap/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('home/theme/template/css/app/alt-app.css')}}">     
              ...
              <nav class="navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse justify-content-stretch" id="navbar6">
                  <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{asset('home/theme/files/CITC.pdf')}}">CITC Regulations</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tel:8004320000">Help <i class="fa fa-phone-square"></i> 800 432 0000</a>
                    </li>
                    <li class="nav-item">
                      <a href="/en">
      ...
      <div class="main-slider d-none d-lg-block d-md-block">
        <div class="centered-container">
          ...
          <div class="centered">
            <div class="row">
              <div class="track-no">
              <input type="text" class="form-control" placeholder="Search tracking number">
              </div>
              <div class="track-btn">
      ...
      <div class="home-page-footer">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="copyright">
              <h6>All Right Reserved © Al Yamamah Express 2022</h6>
              </div>
            </div>
            <div class="col-lg-6">
